...
export default function DashboardPage() {
  ...
  async function loadData() {
    ...
    const { data: activeJobs } = await supabase.from("jobs").select("id, title, job_number, start_date").eq("status", "offen").neq("is_deleted", true).order("start_date", { ascending: true, nullsFirst: false });
