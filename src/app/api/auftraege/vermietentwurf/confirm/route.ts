...
// Liegt unter /api/auftraege/vermietentwurf/confirm — der Pfad, den die neuen
// Vermietentwurf-Mails (vom redesign-Branch) im Link tragen. Daten werden in
// der jobs-Tabelle gehalten (status='anfrage', request_step 1..5).
//
// type=konditionen -> request_step >= 3 (Schritt 1 -> Schritt 3, "Konditionen bestätigt" als 2 wird übersprungen)
// type=angebot     -> request_step >= 5 (Schritt 3 -> Schritt 5, "Angebot bestätigt" als 4 wird übersprungen)
//
